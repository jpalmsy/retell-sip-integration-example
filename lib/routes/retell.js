...
const onRefer = (session, evt) => {
  ...
  // Override the referTo header with the CTM queue SIP URI if TEST_REFER_QUEUE is set.
  // Otherwise, use the value provided in refer_details.refer_to_user.
  const referToUri = process.env.TEST_REFER_QUEUE ? process.env.CTM_QUEUE_URI : refer_details.refer_to_user;
